...
// VPN配置
static NSString *VPNServerAddress = @"58.222.107.149";
static NSString *VPNUserName = @"vpnuser1";
static NSString *VPNPassWord = @"hello123";
static NSString *VPNSharedSecret = @"hellohctx";
//static NSString *VPNLocalizedDescription = @"慧车天下"; // VPN的名称，会显示在设置里
