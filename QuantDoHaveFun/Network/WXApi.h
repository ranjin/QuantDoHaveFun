...
//const static NSString *APIKey = @"c80bb24d7dd06a8aff37e645f07c0ac8";    //UAT环境
...
static NSString *const api_saveHotelCouponDetail = @"/lyjfapp/api/v1/hotelCoupon/saveHotelCouponDetail";  //参与房券活动
