...
#define APP_LIGTHGRAYLINECOLOR        RGB_COLOR_String(@"#F3F7F9")
#define APP_BLUETEXTCOLOR        RGB_COLOR_String(@"#009073")
#define APP_LIGHTBLUETEXTCOLOR        RGB_COLOR_String(@"#00BA95")
